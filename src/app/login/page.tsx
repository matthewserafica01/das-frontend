          ...
          <div className="flex flex-col items-center py-4 self-center">
            <div className="w-2/3 p-6 rounded-lg h-full">
              <div className=" px-10 py-1.5 pb-6">
                ...
                <p className="font-semibold text-gray-500 mb-2">Enter your details and login!</p>
              </div>
              <div className="px-10 space-y-4">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                      <p className="text-sm">
                        No account yet? Register <Link href="/register"><span className="hover:underline hover:text-blue-500">here</span></Link>
                      </p>
                    </div>
                    <Button className="w-full hover:cursor-pointer" size="lg" type="submit">Login</Button>
                  </form>
                </Form>
              </div>
            </div>
